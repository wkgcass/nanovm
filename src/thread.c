...
nvm_thread_mgr_t* NanoVM_create_thread_mgr(nvm_ctx_t* ctx) {
  // TODO
  NanoVM_debug_log0("NanoVM_create_thread_mgr");
  return NULL;
}

void NanoVM_release_thread_mgr(nvm_ctx_t* ctx, nvm_thread_mgr_t* thread_mgr) {
  // TODO
  NanoVM_debug_log0("NanoVM_release_thread_mgr");
}

nvm_thread_t* NanoVM_create_thread(nvm_ctx_t* ctx) {
  // TODO
  NanoVM_debug_log0("NanoVM_create_thread");
  return NULL;
}

int NanoVM_start_thread(nvm_ctx_t* ctx, nvm_thread_t* thread) {
  // TODO
  NanoVM_debug_log0("NanoVM_start_thread");
  return 0;
}

int NanoVM_stop_thread(nvm_ctx_t* ctx, nvm_thread_t* thread) {
  // TODO
  NanoVM_debug_log0("NanoVM_stop_thread");
  return 0;
}

void NanoVM_release_thread(nvm_ctx_t* ctx, nvm_thread_t* thread) {
  // TODO
  NanoVM_debug_log0("NanoVM_release_thread");
}
